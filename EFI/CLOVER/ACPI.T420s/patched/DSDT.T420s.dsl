...
DefinitionBlock ("DSDT.aml", "DSDT", 1, "Apple ", "TP-8C   ", 0x00001380)
{
    ...
    Scope (_SB)
    {
        Method (_INI, 0, NotSerialized)  // _INI: Initialize
        {
            ...
            Store (SRU7, ^PCI0.EHCD.RID) /* \_SB_.PCI0.EHCD.RID_ */
            Store (SRU8, ^PCI0.EHCA.RID) /* \_SB_.PCI0.EHCA.RID_ */
...
/* tjl
   ...
   tjl */
            ...
            Device (EHCD)
            {
                ...
                Method (_INI, 0, NotSerialized)  // _INI: Initialize
                {
                    Store (One, PWKI) /* \_SB_.PCI0.EHCD.PWKI */
                    Store (0x23, PWUC) /* \_SB_.PCI0.EHCD.PWUC */
                }
            ...
            Device (EHCA)
            {
                ...
                Method (_INI, 0, NotSerialized)  // _INI: Initialize
                {
                    Store (One, PWKI) /* \_SB_.PCI0.EHCA.PWKI */
                    Store (0x13, PWUC) /* \_SB_.PCI0.EHCA.PWUC */
                }
...
/* tjl
   ...
   tjl */
    ...
    Scope (_SB.PCI0.EHCA.URTH.URMH.PRTC)
    {
        Name (_EJD, "\\_SB.GDCK")  // _EJD: Ejection Dependent Device
    }

    Scope (_SB.PCI0.EHCD.URTH.URMH.PRT5)
    {
    ...
    {
        Name (_EJD, "\\_SB.PCI0.EHCD.URTH.URMH.PRT5")  // _EJD: Ejection Dependent Device
    }
    ...
    Scope (_SB)
    {
        Device (PNLF)
        {
            ...
            OperationRegion (BRIT, SystemMemory, And (^PCI0.IGPU.BAR1, 0xFFFFFFF0), 0x000E1184)
            ...
            Method (_BCM, 1, NotSerialized)  // _BCM: Brightness Control Method
            {
                ...
                {
                    Store (KPCH, PCHL) /* \_SB_.PNLF.PCHL */
                }

                If (LNotEqual (LEVW, 0x80000000))
                {
                    Store (0x80000000, LEVW) /* \_SB_.PNLF.LEVW */
                }
                ...
                {
                    Store (0x80000000, LEV2) /* \_SB_.PNLF.LEV2 */
                }

                Store (DerefOf (Index (_BCL, Local0)), LEVL) /* \_SB_.PNLF.LEVL */
            }
            ...
            Method (XBCM, 1, NotSerialized)
            {
                ...
                Store (Arg0, LEVL) /* \_SB_.PNLF.LEVL */
            }
